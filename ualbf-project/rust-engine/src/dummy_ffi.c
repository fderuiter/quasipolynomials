...
uint32_t ualbf_target_min_log10() { return 43; }
uint32_t ualbf_target_max_log10() { return 45; }
uint64_t ualbf_sieve_limit() { return 250000; }
uint32_t ualbf_max_exponent() { return 4; }
uint64_t ualbf_prefix_stop_threshold() { return 100000000000ULL; }
uint32_t ualbf_raycast_gpu_threshold() { return 100000; }
uint32_t ualbf_raycast_chunk_size() { return 10000000; }

const char* lean_string_cstr(void* str) { return "dummy_hash"; }
void* ualbf_logic_hash() { return (void*)1; }

uint64_t ualbf_cryptographic_handshake(uint64_t challenge) { return 0; }
