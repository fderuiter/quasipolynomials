...
Zsigmondy applied to QPNs: exponent inflation guarantees generation of
a primitive prime q. If q ≡ 5 or 7 (mod 8), the exponent is mathematically
forbidden for a quasiperfect number.
-/

namespace UALBF.QPN.PoisonTrap

open UALBF UALBF.Pure.Zsigmondy UALBF.QPN.Obstruction UALBF.QPN.BasicProperties
open Finset Nat Polynomial

/--
  The Poison Trap: Zsigmondy + Legendre-Cattaneo.
  Exponent inflation logically guarantees the generation of a primitive prime q.
  If q ≡ 5 or 7 (mod 8), the exponent is mathematically forbidden for a QPN.
-/
