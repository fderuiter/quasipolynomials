...
- [ ] **9.2.1** Run `lake build` (full) — confirm zero errors, zero `sorry`
  - Capture output and verify all UALBF modules compile without warnings

- [ ] **9.2.2** Run `cargo build --release` in `rust-engine/`
...
- [ ] **9.2.3** Run `cargo test` to verify FFI cross-checks still pass
