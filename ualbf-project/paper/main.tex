...
incrementally by the Rust engine's depth-first search, while the suffix is
determined (or shown to be impossible) by a constant-time ray-cast.
...
the unique residue class of $N_R$ and checks whether any integer in that
class satisfies the remaining constraints---all in $\mathcal{O}(1)$ time.
